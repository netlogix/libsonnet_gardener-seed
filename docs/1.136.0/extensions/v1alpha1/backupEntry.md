---
permalink: /1.136.0/extensions/v1alpha1/backupEntry/
---

# extensions.v1alpha1.backupEntry
...
* [`obj spec`](#obj-spec)
  * [`fn withBackupBucketProviderStatus(backupBucketProviderStatus)`](#fn-specwithbackupbucketproviderstatus)
  * [`fn withBackupBucketProviderStatusMixin(backupBucketProviderStatus)`](#fn-specwithbackupbucketproviderstatusmixin)
...
new returns an instance of BackupEntry
...
### fn spec.withBackupBucketProviderStatus

```ts
withBackupBucketProviderStatus(backupBucketProviderStatus)
```
...
### fn spec.withBackupBucketProviderStatusMixin

```ts
withBackupBucketProviderStatusMixin(backupBucketProviderStatus)
```
